...
@register_model("plmtransformer")
class PLMTransformerModel(FairseqEncoderDecoderModel):
    """
    ...
    def add_args(parser):
        ...
        #plm-nmt parameters
        parser.add_argument("--source-plm", type=str, metavar='N',
                            help='the name of source pretrained language model')
        parser.add_argument("--layer-number-splm", type=int, metavar='N',
                            help='the number of used plm layers', default=0)
        parser.add_argument("--dropout-splm", type=float, metavar='D',
        ...
        parser.add_argument("--target-plm", type=str, metavar='N',
                            help='the name of target plm')
        parser.add_argument("--layer-number-tplm",type=int,metavar='N',
                            help='the number of userd plm layers', default=0)
...
class PLMTransformerEncoder(FairseqEncoder):
    """
